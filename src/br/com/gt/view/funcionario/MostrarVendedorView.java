 ...
 * @author lucas
 */
public class MostrarVendedorView extends javax.swing.JFrame {

    /**
     * Creates new form VendedorMostrarView
     */
    public MostrarVendedorView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel17.setText("Dados do Funcionário");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarVendedorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarVendedorView().setVisible(true);
            }
        });
    }
