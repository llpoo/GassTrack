 ...
 * @author lucas
 */
public class CadastrarMaterialView extends javax.swing.JDialog {
    ...
    /**
     * Creates new form MaterialCadastroView
     */
    public CadastrarMaterialView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel17.setText("Cadastrar Material");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarMaterialView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastrarMaterialView dialog = new CadastrarMaterialView(new javax.swing.JFrame(), true);
