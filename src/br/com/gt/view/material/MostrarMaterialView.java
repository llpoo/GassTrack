 ...
 * @author lucas
 */
public class MostrarMaterialView extends javax.swing.JDialog {

    /** Creates new form MaterialMostrarView */
    public MostrarMaterialView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel17.setText("Dados do Material");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarMaterialView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MostrarMaterialView dialog = new MostrarMaterialView(new javax.swing.JFrame(), true);
